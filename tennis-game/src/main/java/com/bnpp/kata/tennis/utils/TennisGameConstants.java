...
public class TennisGameConstants {
	...
	public static final String GAME_WON_RESULT = " Won the game";
	public static final String DEFAULT_FIRST_PLAYER_NAME = "FirstPlayer";
	public static final String DEFAULT_SECOND_PLAYER_NAME = "SecondPlayer";
	public static final String INITIAL_GAME_SCORE = "";
